...
# ------------------------------
# 3. Building the Bidirectional LSTM Model
# ------------------------------
...
model = Sequential([
    ...
    # First Bidirectional LSTM layer with return_sequences=True for stacking LSTMs
    Bidirectional(LSTM(64, return_sequences=True), input_shape=(input_timesteps, input_features)),
    Dropout(0.2),
    
    # Second Bidirectional LSTM layer; return_sequences=False since it's the final LSTM layer
